...
def main(searchItem):
    url = 'http://www.metacritic.com/game/playstation-4/' + searchItem + '/'
...
def search():
    inp = raw_input("What game are you looking for? ")
    print(inp)
    main(inp)
